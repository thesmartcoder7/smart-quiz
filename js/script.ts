...
const questionForm = document.querySelector(".quiz-form") as HTMLFormElement;
const scoreTag = document.querySelector(".result-display") as HTMLDivElement;
const reloadBtn = document.querySelector(".reload") as HTMLButtonElement;
var totalScore = document.querySelector(".score") as HTMLSpanElement;
var scoreRemark = document.querySelector(".remark") as HTMLSpanElement;
var score = 0;
...
if (questionForm) {
  questionForm.addEventListener("submit", (e) => {
    ...
    let percentageScore: number = Number(
